...
_PBTASKPROXY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='flow_labels', full_name='PbTaskProxy.flow_labels', index=17,
      number=20, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_flow_labels', full_name='PbTaskProxy._flow_labels',
      index=11, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
...
_PBTASKPROXY.oneofs_by_name['_flow_labels'].fields.append(
  _PBTASKPROXY.fields_by_name['flow_labels'])
_PBTASKPROXY.fields_by_name['flow_labels'].containing_oneof = _PBTASKPROXY.oneofs_by_name['_flow_labels']
