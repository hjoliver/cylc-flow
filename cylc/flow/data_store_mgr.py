...
class DataStoreMgr:
    ...
    def increment_graph_window(
        ...
        Args:
            ...
            flow_labels (str):
                Flow labels used to distinguish multiple flows.
            edge_distance (int):
        ...
        for items in itask.graph_children.values():
            ...
            self._expand_graph_window(
                s_id, s_node, items, active_id, itask.flow_labels,
    ...
    def _expand_graph_window(
            self, s_id, s_node, items, active_id, flow_labels,
        ...
        for t_name, t_point, _ in items:
            ...
            self.increment_graph_window(
                TaskProxy(
                    ...
                    t_point, flow_labels, submit_num=0
                ),
